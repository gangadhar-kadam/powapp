...
cur_frm.cscript.callback = function(doc, dt, dn, ltln, ip){
	...
	google.maps.event.addListener(searchBox, 'place_changed', function() {
		...
		//console.log([place.formatted_address, place.geometry.location.D, place.geometry.location.k])
		cur_frm.cscript.create_pin_on_map(doc,place.geometry.location.A,place.geometry.location.F)		
		cur_frm.set_value('lat',place.geometry.location.A)
		cur_frm.set_value('lon',place.geometry.location.F)
		cur_frm.set_value("address", place.formatted_address)
	});
